...
exports.substituteCodepoint = substituteCodepoint;
exports.hasShortcutModifier = hasShortcutModifier;
exports.hasCharModifier = hasCharModifier;
exports.ModifierSync = ModifierSync;
exports.getKey = getKey;
exports.getKeysym = getKeysym;
exports.keysymFromKeyCode = keysymFromKeyCode;
exports.nonCharacterKey = nonCharacterKey;
exports.QEMUKeyEventDecoder = QEMUKeyEventDecoder;
exports.TrackQEMUKeyState = TrackQEMUKeyState;
exports.KeyEventDecoder = KeyEventDecoder;
exports.VerifyCharModifier = VerifyCharModifier;
exports.TrackKeyState = TrackKeyState;
exports.EscapeModifiers = EscapeModifiers;
...
function getKeysym(evt) {
    ...
    if (codepoint) {
        return _keysymdef2.default.fromUnicode(substituteCodepoint(codepoint));
    }
