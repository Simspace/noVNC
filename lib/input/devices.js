    ...
    _sendKeyEvent: function (keysym, code, down) {
        ...
        if (down && isWindows()) {
            if (code !== 'ControlLeft' && code !== 'AltRight' && 'ControlLeft' in this._keyDownList && 'AltRight' in this._keyDownList) {
                fakeAltGraph = true;
                this._onKeyEvent(_keysym2.default.XK_Alt_R, 'AltRight', false);
                this._onKeyEvent(_keysym2.default.XK_Control_L, 'ControlLeft', false);
            }
        }
        ...
        if (fakeAltGraph) {
            this._onKeyEvent(_keysym2.default.XK_Control_L, 'ControlLeft', true);
            this._onKeyEvent(_keysym2.default.XK_Alt_R, 'AltRight', true);
        }
    },
