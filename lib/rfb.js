...
RFB.prototype = {
    ...
    sendCtrlAltDel: function () {
        ...
        this.sendKey(this._sock, _keysym2.default.XK_Control_L, true);
        this.sendKey(this._sock, _keysym2.default.XK_Alt_L, true);
        this.sendKey(this._sock, _keysym2.default.XK_Delete, true);
        this.sendKey(this._sock, _keysym2.default.XK_Delete, false);
        this.sendKey(this._sock, _keysym2.default.XK_Alt_L, false);
        this.sendKey(this._sock, _keysym2.default.XK_Control_L, false);
        return true;
    },
...
RFB.prototype.set_local_cursor = function (cursor) {
    ...
    if (this._rfb_connection_state === "connected") {
        RFB.messages.clientEncodings(this._sock, this._encodings, cursor, this._true_color);
    }
};
