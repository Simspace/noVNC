...
function Display(defaults) {
    ...
    if (_browsers.Engine.gecko) {
        Log.Debug("Browser: gecko " + _browsers.Engine.gecko);
    }
    if (_browsers.Engine.webkit) {
        Log.Debug("Browser: webkit " + _browsers.Engine.webkit);
    }
    if (_browsers.Engine.trident) {
        Log.Debug("Browser: trident " + _browsers.Engine.trident);
    }
    if (_browsers.Engine.presto) {
        Log.Debug("Browser: presto " + _browsers.Engine.presto);
    }
